  ...
  return (
    <div className='p-4'>
      ...
      <p>
        ...
        accordance with and subject to, prevailing law of Philippines. Any use of the
      ...
      <p>
        ...
        Kadiwa for your own personal use subjected to restrictions set in these
      ...
      <p>
        ...
        the state and federal courts located in India for the resolution of any
        disputes.
      </p>
    </div>
  );
