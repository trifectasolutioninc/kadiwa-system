...
const RegistrationPage = () => {
  ...
  const handlePartnerSubmit = async (e) => {
    ...
    // Validate required inputs
    if (
      isBlank(partnerFormData.ownerContact) ||
      isBlank(partnerFormData.partnerPassword) ||
      isBlank(partnerFormData.confirmPartnerPassword)
    ) {
      alert("Please fill in all required fields.");
      return;
    }
    ...
    // Validate password match
    if (
      partnerFormData.partnerPassword !== partnerFormData.confirmPartnerPassword
    ) {
      alert("Passwords do not match.");
      return;
    }
    ...
    switch (activeForm) {
            ...
            >
              ...
              <div className="items-center">
                <button
                  type="submit"
                  id="consumerSubmit"
                  className="w-full py-2 px-4 bg-blue-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-300"
                >
                  Register
                </button>
              </div>
      ...
      case "partner":
        return (
          <div
            id="partnerForm"
            className=" mt-8 p-8 rounded overflow-auto"
            onSubmit={handlePartnerSubmit}
          >
            <form action="#" className="space-y-4">
              <div className="space-y-2 text-left">
                <label htmlFor="storeName" className="text-sm text-white">
                  Store Name
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-2 text-left">
                <label htmlFor="storeType" className="text-sm text-white">
                  Type of Store
                </label>
                <select
                  id="storeType"
                ...
                >
                  ...
                  <option value="omnichannel">
                    Omnichannel Store (Physical/Online)
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-2 text-left">
                <label htmlFor="landmark" className="text-sm text-white">
                  Store Landmark (Optional)
                </label>
                <input
                  type="text"
                  id="landmark"
                  name="landmark"
                  placeholder="Build No/Street/Other"
                  className="w-full p-2 border rounded-md"
                />
              </div>

              <div className="space-y-2 text-left">
                <label htmlFor="ownerName" className="text-sm text-white">
                  Owner Fullname
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-2 text-left">
                <label htmlFor="ownerContact" className="text-sm text-white">
                  Contact Number
                </label>
                <input
                  type="tel"
              ...
              <div className="space-y-2 text-left">
                <label htmlFor="partnerPassword" className="text-sm text-white">
                  Password
                </label>
                <input
                  type="password"
              ...
              <div className="space-y-2 text-left">
                <label
                  htmlFor="confirmPartnerPassword"
                ...
                <input
                  type="password"
                  id="confirmPartnerPassword"
                  name="confirmPartnerPassword"
                  placeholder="Confirm Password"
                  className="w-full p-2 border rounded-md"
                  required
                />
  ...
  return (
    <div
      className="flex flex-col m-0 items-center text-center justify-center max-h-screen h-screen"
      style={{ background: "linear-gradient(to bottom, #309340, #0D5B19)" }}
    >
      ...
      <div>
        <button
          id="consumerBtn"
          className={`p-1 font-bold rounded-2xl ${
            activeForm === "consumer"
              ? "bg-blue-500 text-white"
              : "bg-white text-black"
          }`}
          onClick={() => switchForm("consumer")}
        >
          Consumer
        </button>
        <button
      ...
      <div
        id="consumerSuccessModal"
        className="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center"
      >
      ...
      >
        <div className="bg-white p-8 rounded shadow-md">
          ...
          <p className="mb-4">
            Your account has been successfully registered. Your store is pending
            for accreditation.
          </p>
          <button
            id="partnerSuccessOkayBtn"
            className="bg-blue-500 text-white px-4 py-2 rounded"
          >
            OKAY
          </button>
