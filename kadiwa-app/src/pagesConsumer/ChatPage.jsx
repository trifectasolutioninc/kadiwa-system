          ...
          >
            <div
              className={`inline-block p-2 rounded-lg ${
                message.sender === 'consumer' ? 'bg-green-500 text-white' : 'bg-white'
              }`}
            >
              <p>{message.text}</p>
              
            </div>
            <p className={`text-xs text-gray-500 ${message.sender === 'consumer' ? 'text-right ' : 'text-left'}`}>{formatDate(message.time)}</p>
