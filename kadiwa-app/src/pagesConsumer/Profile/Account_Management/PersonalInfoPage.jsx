...
const PersonalInfoPage = () => {
    ...
    useEffect(() => {
        ...
        get(child(dbRef, `users_information/${uid}`)).then((snapshot) => {
            if (snapshot.exists()) {
                ...
                <div className="">
                    <div className="p-4 flex items-center bg-white border-b">
                        <NavLink to={"/route/profileedit"}>
                            <IoMdArrowRoundBack className="text-gray-600 text-2xl cursor-pointer" />
                        </NavLink>
                        ...
                        <div className="mb-4">
                            ...
                            <div className="relative border rounded w-full bg-white shadow">
                                <div className="absolute top-0 right-0 m-3  text-gray-600 w-fit cursor-pointer">
                                    <FaCalendar onClick={() => document.getElementById('datepicker').click()} />
                                </div>
                                <DatePicker
                                    id="datepicker"
